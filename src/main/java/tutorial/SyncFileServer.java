...
@Generated(value = "Autogenerated by Thrift Compiler (0.9.3)", date = "2016-07-02")
public class SyncFileServer {
  ...
  public interface Iface extends shared.SharedService.Iface {
    ...
    public int partCount(String folder, String path) throws org.apache.thrift.TException;
  ...
  public interface AsyncIface extends shared.SharedService .AsyncIface {
    ...
    public void partCount(String folder, String path, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends shared.SharedService.Client implements Iface {
    ...
    public int partCount(String folder, String path) throws org.apache.thrift.TException
    {
      send_partCount(folder, path);
      return recv_partCount();
    }

    public void send_partCount(String folder, String path) throws org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends shared.SharedService.AsyncClient implements AsyncIface {
    ...
    public void partCount(String folder, String path, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException {
      checkReady();
      partCount_call method_call = new partCount_call(folder, path, resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }
    ...
    public static class partCount_call extends org.apache.thrift.async.TAsyncMethodCall {
      private String folder;
      private String path;
      public partCount_call(String folder, String path, org.apache.thrift.async.AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.folder = folder;
        this.path = path;
      }
  ...
  public static class Processor<I extends Iface> extends shared.SharedService.Processor<I> implements org.apache.thrift.TProcessor {
    ...
    public static class partCount<I extends Iface> extends org.apache.thrift.ProcessFunction<I, partCount_args> {
      ...
      public partCount_result getResult(I iface, partCount_args args) throws org.apache.thrift.TException {
        partCount_result result = new partCount_result();
        result.success = iface.partCount(args.folder, args.path);
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends shared.SharedService.AsyncProcessor<I> {
    ...
    public static class partCount<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, partCount_args, Integer> {
      ...
      public void start(I iface, partCount_args args, org.apache.thrift.async.AsyncMethodCallback<Integer> resultHandler) throws TException {
        iface.partCount(args.folder, args.path,resultHandler);
      }
    }
...
;
  ...
  public static class partCount_args implements org.apache.thrift.TBase<partCount_args, partCount_args._Fields>, java.io.Serializable, Cloneable, Comparable<partCount_args>   {
    ...
    public partCount_args setPath(String path) {
      this.path = path;
      return this;
    }
